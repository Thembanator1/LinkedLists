...
// name is for the subtopic and its questions
const quiz = {
    "name": "Quiz",
    "questions": [{
            "type": "single",
            "question": "Which is not useful in evaluating documents?",
        ...
        {
            "type": "short",
            "question": "Please describe in two sentences or less what Lebo likes.",
            "entered": [],
            "answers": []
        },
        {
            "type": "long",
            "question": "In three paragraphs, describe why alcohol is good for you, ngisho wena Aluzuko. Use examples as needed.",
            "entered": [],
            "answers": []
        }
    ]
